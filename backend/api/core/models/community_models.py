...
class CommunityReport(models.Model):
    ...
    reporter = models.ForeignKey(Community, on_delete=models.DO_NOTHING,  related_name='reporter')
    reported = models.ForeignKey(Community, on_delete=models.CASCADE,  related_name='reported')
